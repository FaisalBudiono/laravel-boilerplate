...
class JWTGuard_User_Test extends JWTGuardBaseTestCase
{
    ...
    #[Test]
    public function should_return_null_and_not_set_any_user_when_jwt_signer_is_throwing_exception_when_validating_token()
    {
        // Arrange
    ...
    #[Test]
    public function should_return_null_and_not_set_any_user_when_jwt_parser_is_throwing_exception_when_parsing_token()
    {
        // Arrange
        $mockedToken = 'xxxxxxxxx';
    ...
    #[Test]
    public function should_return_user_and_set_logged_in_user_when_jwt_token_is_valid()
    {
        // Arrange
