...
class JWTGuard_Check_Test extends JWTGuardBaseTestCase
{
    ...
    #[Test]
    public function should_return_false_when_there_is_some_error_thrown(): void
    {
        // Arrange
    ...
    #[Test]
    public function should_return_true_and_set_logged_in_user_when_token_is_valid(): void
    {
        // Arrange
